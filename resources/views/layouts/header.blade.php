 <header id="header" class="bg-gray-900 w-full z-10 top-0 shadow">
        ...
        <div class="mx-auto mt-0 pt-2 pb-2 pl-4 pr-4">
                    ...
                    <div class="flex relative inline-block float-right">
                        ...
                        <div class="relative text-sm text-gray-100">
                            ...
                            @else
                                ...
                                <a href="{{ route('logout') }}"
                                class="no-underline hover:underline text-gray-300 text-sm p-3 pr-0"
        ...
        <div class="w-full hidden lg:block bg-gray-800 md:pl-4 md:pr-4">
