<div class="flex flex-wrap">
    <div class="w-full lg:w-2/3 mb-6">
        <div class="bg-white shadow-md rounded overflow-hidden h-full">
            <div class="border-b border-grey-light p-4 font-medium">
                <h2 class="uppercase">Signup</h2>
            </div>
    ...
    <div class="w-full lg:w-1/3 lg:pl-5">
        <div class="bg-white shadow-md rounded overflow-hidden">
            <div class="border-b border-grey-light p-4 font-medium">
                <h2 class="uppercase">Latest Signups</h2>
            </div>
