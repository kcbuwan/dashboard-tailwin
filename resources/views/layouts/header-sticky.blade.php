    ...
    <div class="w-full h-16 px-10 bg-white  flex items-center justify-between">
        ...
        <div class="flex items-center relative">
            ...
            <a href="#" class="p-3 mr-4 items-center text-gray-600 hover:text-gray-700 font-semibold leading-none flex lg:inline-flex px-3">
                ...
                <span class="badge mb-3 bg-teal-600 rounded px-2 py-1 text-center object-right-top text-white text-xs font-normal mr-1">24</span>
            </a>

            <a href="#" class="block text-sm font-medium text-white bg-teal-600 hover:bg-gray-400 rounded py-2 px-6 text-center">
                Log out
            </a>
