            ...
            <table class="w-full">
                <tbody>
                    <tr>
                        ...
                        <th class="text-sm text-gray-600 font-semi-bold bg-gray-100 border-b p-4 text-left uppercase">Warehouses</th>
                        <th class="text-sm text-gray-600 font-semi-bold bg-gray-100 border-b p-4 text-left uppercase">Menu</th>
                        <th class="text-sm text-gray-600 font-semi-bold bg-gray-100 border-b p-4 text-left uppercase">Options</th>
                    </tr>
                    <tr>
                    <td class="p-3 text-gray-600 border-solid border-b border-gray-200 font-medium">1</td>
                    <td class="p-3 text-gray-600 border-solid border-b border-gray-200 font-medium">Australia</td>
                    <td class="p-3 text-gray-700 border-solid border-b border-gray-200">
                        <div class="inline-flex">
                            <a href="#" class="bg-blue-400 hover:bg-blue-500 text-gray-100 inline-block px-3 p-1 rounded rounded-r-none text-sm">Primary Menu</a>
                            <a href="#" class="bg-blue-500 hover:bg-blue-600 text-gray-100 block px-3 p-2 rounded rounded-l-none w-10 h-8">
                        ...
                        <div class="inline-flex">
                            <a href="#" class="bg-blue-400 hover:bg-blue-500 text-gray-100 inline-block px-3 p-1 rounded rounded-r-none text-sm">Quick Link</a>
                            <a href="#" class="bg-blue-500 hover:bg-blue-600 text-gray-100 block px-3 p-2 rounded rounded-l-none w-10 h-8">
                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M6 18L18 6M6 6l12 12"></path>
                            </svg>
                        ...
                        <div class="inline-flex">
                            <a href="#" class="bg-blue-400 hover:bg-blue-500 text-gray-100 inline-block px-3 p-1 rounded rounded-r-none text-sm">Mobile Menu</a>
                            <a href="#" class="bg-blue-500 hover:bg-blue-600 text-gray-100 block px-3 p-2 rounded rounded-l-none w-10 h-8">
                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M6 18L18 6M6 6l12 12"></path>
                            </svg>
                    ...
                    <tr>
                        <td class="p-3 text-gray-600 border-solid border-b border-gray-200 font-medium">2</td>
                        <td class="p-3 text-gray-600 border-solid border-b border-gray-200 font-medium">United States</td>
                        <td class="p-3 text-gray-700 border-solid border-b border-gray-200">
                            <div class="inline-flex">
                                <a href="#" class="bg-blue-400 hover:bg-blue-500 text-gray-100 inline-block px-3 p-1 rounded rounded-r-none text-sm">Primary Menu</a>
                                <a href="#" class="bg-blue-500 hover:bg-blue-600 text-gray-100 block px-3 p-2 rounded rounded-l-none w-10 h-8">
                        ...
                        <td colspan="8" class="bg-gray-100 p-4 pt-2 pb-2 mt-4 text-sm text-left">
                            <div class="flex flex-wrap">
                                <div class="w-1/2 text-left self-center">
                                    <span class="text-sm font-bold">Showing 2 of 2 results</span>
                                </div>
                                <div class="w-1/2 text-right">
                                <div class="inline-flex">
