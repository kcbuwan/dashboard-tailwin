...
@section('content')
<div class="flex flex-wrap mb-6 lg:mt-0">
    <div class="w-full lg:w-3/4 rounded-sm shadow bg-white pb-4 text-gray-700 mb-6 lg:mb-0">
        ...
        <div class="flex flex-wrap px-4 pt-4 mb-4">
            <div class="w-full mb-6">

                <h2 class="uppercase pr-4 text-gray-700 font-medium mb-4">Australia Post</h2>

                <label class="block text-sm font-medium text-gray-600 mb-2">
                    Enabled
                </label>
                <div class="inline-flex">
                    <a href="#" class="bg-gray-100 hover:bg-gray-200 text-gray-700 hover:text-gray-600 px-4 py-1 border border-gray-400 text-xs">
                        Yes
                    </a>
                    <a href="#" class="bg-blue-500 hover:bg-blue-500 text-gray-100 px-4 py-1 rounded-sm rounded-l-none text-xs">
                        No
                    </a>
                </div>
            </div>
    ...
    <div class="w-full lg:w-1/4 text-gray-700">
        <div class="lg:ml-6 mb-6">
            <div class="rounded-sm shadow bg-white mb-6">
                <ul class="overflow-hidden p-3">
                    <li>
