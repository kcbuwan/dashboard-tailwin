<x-app>
    ...
    <div class="md:flex pt-3 pb-3 mb-3">
        <div class="mb-4 md:mb-0 md:w-1/2 self-center text-left md:text-left">
            <div class="inline-flex">                            
                <div class="relative mb-4 lg:mb-0">
                    ...
                    <div class="pointer-events-none absolute inset-y-0 right-0 pl-4 pr-4 flex items-left">
                ...
                <div class="relative lg:mb-0">
                    <a href="#" class="ml-2 bg-blue-500 hover:bg-blue-600 outline-none focus:border-blue-900 rounded text-white py-3 px-2 inline-flex text-sm font-medium">
                        ...
                        <span class="pointer-events-none inset-y-0 right-0 flex items-left pl-2 text-white">
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-100 border-b">
                        ...
                        <th class="text-sm text-gray-600 font-semi-bold bg-gray-100 border-b p-4 text-left uppercase">Date</th>
                        <th class="text-sm text-gray-600 font-semi-bold bg-gray-100 border-b p-4 text-left uppercase">Amount</th>
                        <th class="text-sm text-gray-600 font-semi-bold bg-gray-100 border-b p-4 text-left uppercase">Status</th>
                    </tr>
                </thead>
                <tbody class="mb-4">
                    ...
                    <tr class="border-solid border-b border-gray-200">
                        ...
                        <td class="text-sm p-4 pt-2 pb-2 text-gray-700 border-solid border-b border-gray-200 w-32 text-left">
                            26 Sep, 2019 06:58 pm
                        </td>
                        <td class="text-sm p-4 pt-2 pb-2 text-gray-700 border-solid border-b border-gray-200 text-left">$12,000.00</td>
                        <td class="p-4 text-gray-700 border-solid border-b border-gray-200 text-right">
                            <span class="flex items-center">
                                <span class="px-3 py-1 rounded-full text-xs uppercase font-medium bg-green-200 text-green-800">Completed</span>
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr class="border-solid border-b border-gray-200">
                        ...
                        <td class="text-sm p-4 pt-2 pb-2 text-gray-700 w-32 text-left">
                            26 Sep, 2019 06:58 pm
                        </td>
                        <td class="text-sm p-4 pt-2 pb-2 text-gray-700 text-left">$10,000.00</td>
                        <td class="p-4 text-gray-700 border-solid border-b border-gray-200 text-right">
                            <span class="flex items-center">
                                <span class="px-3 py-1 rounded-full text-xs uppercase font-medium bg-orange-200 text-orange-800">Pending</span>
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr class="border-solid border-b border-gray-200">
                        ...
                        <td class="text-sm p-4 pt-2 pb-2 text-gray-700 text-left">$12,000.00</td>
                        <td class="p-4 text-gray-700 border-solid border-b border-gray-200 text-right">
                            <span class="flex items-center">
                                <span class="px-3 py-1 rounded-full text-xs uppercase font-medium bg-blue-200 text-blue-800">Processing</span>
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr class="border-solid border-b border-gray-200">
                        ...
                        <td class="text-sm p-4 pt-2 pb-2 text-gray-700 border-solid border-b border-gray-200 text-left">$1,000.00</td>
                        <td class="p-4 text-gray-700 border-solid border-b border-gray-200 text-right">
                            <span class="flex items-center">
                                <span class="px-3 py-1 rounded-full text-xs uppercase font-medium bg-green-200 text-green-800">Completed</span>
                            </span>
                    ...
                    <tr class="border-solid border-b border-gray-200">
                        ...
                        <td class="text-sm p-4 pt-2 pb-2 text-gray-700 text-left">$9,000.00</td>
                        <td class="p-4 text-gray-700 border-solid border-b border-gray-200 text-right">
                            <span class="flex items-center">
                                <span class="px-3 py-1 rounded-full text-xs uppercase font-medium bg-blue-200 text-blue-800">Processing</span>
                            </span>
