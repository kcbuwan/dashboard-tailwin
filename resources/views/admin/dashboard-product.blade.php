...
@section('content')
    ...
    <div id="main-content" class="w-full bg-gray-100 pl-0 lg:pl-64 min-h-screen">
        <div class="sticky top-0 z-40">
            ...
            <div class="lg:flex px-10 bg-white justify-between items-center">
                <div class="w-full border-t lg:flex items-center h-16 border-gray-400">
                    <p class="text-2xl font-bold mb-2 lg:mb-0 text-gray-700">Hello Element 7 Digital</p>
                </div>
            </div>
        </div>
            ...
            <div class="lg:mt-0 rounded shadow bg-white mb-6 ">
                <div class="flex p-4 pt-2 pb-2 border-b border-bg-gray-300">
                    <div class="w-1/2 self-center">
                        <h2 class="uppercase pull-right pr-4 text-gray-700 font-bold">Products</h2>
                    </div>
                </div>
                <div class="md:flex p-4 pt-3 pb-3">
                    <div class="mb-4 md:mb-0 md:w-1/2 self-center text-center md:text-left">
                        <div class="inline-flex">
                            ...
                            <button class="ml-2 bg-blue-600 hover:bg-blue-700 outline-none focus:border-teal-900 text-white py-1 px-6 shadow inline-flex text-sm font-medium">
                            Add Product
                        </button>
                        </div>
                    </div>
                    <div class="md:w-1/2 text-center md:text-right">
                        <div class="lg:inline-flex">
                            ...
                            <div class="relative mb-4 lg:mb-0">
                                <select class="w-full appearance-none py-2 px-4 pr-8 h-10 leading-tight bg-blue-600 hover:bg-blue-700 outline-none focus:border-teal-900 text-white">
                                    <option>Select Warehouse</option>
                                    <option>All</option>
                                    <option>Australia</option>
                                    <option>United States</option>
                                </select>
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-white"><svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"></path></svg></div>
                            </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-gray-200 rounded shadow">
                                ...
                                <th class="text-sm text-gray-600 font-bold  p-4 text-left" style="width: 50px;">
                                    ID
                                </th>
                                <th class="text-sm text-gray-600 font-bold  p-4 text-left">Product Name</th>
                                <th class="text-sm text-gray-600 font-bold  p-4 text-left">Warehouse</th>
                                <th class="text-sm text-gray-600 font-bold  p-4 text-left">Variants</th>
                                <th class="text-sm text-gray-600 font-bold  p-4 text-left">Order</th>
                                <th class="text-sm text-gray-600 font-bold  p-4 text-left"> Created At</th>
                                <th class="text-sm text-gray-600 font-bold  p-4 text-center">Quick Links</th>
                                <th class="text-sm text-gray-600 font-bold  p-4 text-right">Options</th>
                            </tr>
                        </thead>
                        <tbody class="mb-4">
                            <tr>
                                ...
                                <td class="p-4 text-gray-700 text-sm text-right">
                                    <ul class="inline-flex">
                                        <li>
                                            <button class="block text-xs text-gray-900 border-solid bg-white border border-gray-400 hover:border-gray-500 rounded-sm py-1 px-2 mr-1 h-8 text-center">
                                                Duplicate
                                            </button>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <button class="block text-xs text-white border-solid bg-green-400 border border-gray-400 hover:border-gray-500 rounded-sm py-1 px-2 mr-1 h-8 text-center">
                                                Enabled
                                            </button>
                                        </li>
