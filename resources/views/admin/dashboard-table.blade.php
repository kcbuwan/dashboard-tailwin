...
@section('content')
    ...
    <div id="main-nav" class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-800 z-30 hidden">
        <div class="w-full h-16 bg-gray-900 flex flex-wrap px-4 items-center mb-6 text-center">
        ...
        <div class="mb-4 px-3">
            ...
            <div class="w-full flex items-center text-white h-10 px-2 bg-gray-900 rounded cursor-pointer">
            ...
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                ...
                </svg><span class="text-gray-300">Analytics</span>
            </div>
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                <svg viewBox="0 0 20 20" class="h-6 w-6 fill-current mr-2">
                ...
                </svg><span class="text-gray-300">Inventory</span>
            </div>
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                <svg viewBox="0 0 20 20" class="h-6 w-6 fill-current mr-2">
                ...
                </svg><span class="text-gray-300">Enquiries</span>
            </div>
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                <svg viewBox="0 0 20 20" class="h-6 w-6 fill-current mr-2">
                ...
                </svg><span class="text-gray-300">Calender</span>
            </div>
        </div>
        <div class="mb-4 px-3">
            ...
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                ...
                </svg><span class="text-gray-300">Add Product</span>
            </div>
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                <svg viewBox="0 0 20 20" class="h-6 w-6 fill-current mr-2">
                ...
                </svg><span class="text-gray-300">View Products</span>
            </div>
        </div>
        <div class="mb-4 px-3">
            ...
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                ...
                </svg><span class="text-gray-300">Notices</span>
            </div>
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                <svg viewBox="0 0 20 20" class="h-6 w-6 fill-current mr-2">
                ...
                </svg><span class="text-gray-300">Controls</span>
            </div>
            <div class="w-full flex items-center text-gray-100 h-10 px-2 hover:bg-gray-900 rounded cursor-pointer">
                <svg viewBox="0 0 20 20" class="h-6 w-6 fill-current mr-2">
     ...
     <div id="main-content" class="w-full bg-gray-100 pl-0 lg:pl-64 min-h-screen">
        <div class="sticky top-0 z-40">
            <div class="w-full h-16 px-6 bg-white shadow flex items-center justify-between">
                <div class="flx">
                    ...
                    <div class="align-middle inline-block min-w-full shadow overflow-hidden rounded border-b border-gray-200">
                        <table class="min-w-full">
                            <thead class="bg-white">
                                <tr>
                                    <th class="px-6 py-4 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                    Name
                                    </th>
                                    <th class="px-6 py-4 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                    Title
                            ...
                            <tbody class="bg-white">
                                <tr>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-white-200">
