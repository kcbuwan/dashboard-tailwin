...
@section('content')
    ...
    <div id="main-content" class="w-full bg-gray-100 pl-0 lg:pl-64 min-h-screen">
        ...
        <div class="p-10 bg-gray-200">
            ...
            <div class="lg:mt-0 rounded pt-2 shadow bg-white mb-6 ">
                <div class="md:flex p-4 pt-3 pb-3">
                    <div class="mb-4 md:mb-0 md:w-1/2 self-center text-center md:text-left">
                        <div class="inline-flex">                            
                            ...
                            <button class="ml-2 bg-blue-600 hover:bg-blue-700 outline-none focus:border-teal-900 text-white py-2 px-6 shadow inline-flex text-sm font-medium">
                                Add Product
                            </button>
                        </div>
                    </div>
                    <div class="md:w-1/2 text-center md:text-right">
                        <div class="lg:inline-flex">
                            ...
                            <div class="relative mb-4 lg:mb-0">
                                <a href="#" class="ml-2 bg-blue-600 hover:bg-blue-700 outline-none focus:border-teal-900 rounded text-white py-2 px-6 shadow inline-flex text-sm font-medium">
                ...
                <div class="overflow-hidden overflow-x-auto p-4 pt-0">
                    <table class="w-full">
                        ...
                        <tbody class="mb-4">
                            <tr>
                                <td class="text-sm p-4 pt-2 pb-2 border-solid border-b border-gray-200 text-gray-700"><i class="fas fa-arrows-alt"></i></td>
                                <td class="p-4 border-solid border-b border-gray-200 text-gray-700">
                                    <input class="mr-2 leading-tight" type="checkbox">
                                </td>
                                <td class="text-sm p-4 pt-2 pb-2 border-solid border-b border-gray-200 text-gray-700" style="width: 50px;">
                                    1
                                </td>
                                <td class="text-sm p-4 pt-2 pb-2 border-solid border-b border-gray-200 text-gray-700 w-64">Tester US Product  </td>
                                <td class="text-sm p-4 pt-2 pb-2 border-solid border-b border-gray-200 text-gray-700">
                                ...
                                <td class="text-sm p-4 pt-2 pb-2 border-solid border-b border-gray-200 text-gray-700 w-32">
