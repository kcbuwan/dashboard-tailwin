    ...
    <div class="flex flex-wrap lg:mt-0 mb-6">
        <div class="w-full lg:w-3/4 rounded-sm shadow bg-white pb-4 text-gray-700">
            <div class="p-4 pt-2 pb-2 border-b border-bg-gray-300 mb-4">
                <h2 class="uppercase pr-4 text-gray-700 text-lg font-medium">Cart Products</h2>
            </div>
            <div class="px-4 mb-4">
        ...
        <div class="w-full lg:w-1/4 text-gray-700">
            ...
            <div class="rounded-sm shadow bg-white pb-2 mt-4 lg:mt-0 lg:ml-6 mb-6">
            ...
            <div class="rounded-sm shadow bg-white pb-2 mt-4 lg:mt-0 lg:ml-6">
                <div class="flex border-b border-grey-light p-4 pt-2 pb-2 mb-2 font-medium">
