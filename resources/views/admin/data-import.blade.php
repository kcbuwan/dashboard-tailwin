    ...
    <div class="flex flex-wrap lg:mt-0 mb-6">
        ...
        <div class="w-full lg:w-3/4">
            ...
            <div class="px-4 mb-4 p-4">
                ...
                <div class="relative">
                    <select class="w-full form-select" id="type-of-import">
                        <option>
                            Please Select...
                        </option>
            ...
            <div class="w-full text-gray-600 px-4">
                <div class="rounded-sm  border border-bg-gray-300 mb-4">
                    ...
                    <div class="p-4">
                        ...
                        <label class="w-64 flex flex-col items-center px-4 py-4 bg-white text-teal-600 rounded shadow tracking-wide border border-teal-300 cursor-pointer hover:bg-teal-600 hover:text-white">
