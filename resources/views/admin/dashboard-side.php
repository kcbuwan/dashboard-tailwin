...
@section('content')
    ...
    <div id="main-nav" class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-700 z-30 hidden">
        <div class="w-full h-16 bg-gray-700 flex flex-wrap px-4 items-center mb-6 text-center">
    ...
    <div id="main-content" class="w-full bg-gray-800 pl-0 lg:pl-64 min-h-screen">
        <div class="sticky top-0 z-40">
            <div class="w-full h-16 px-10 flex items-center justify-between">
                <div class="flx">
                ...
                <div class="flex items-center relative">
                    <a href="#" class="p-3 items-center text-gray-400 hover:text-gray-700 font-semibold text-sm leading-none flex lg:inline-flex border-r border-gray-200 px-3">
                    ...
                    <a href="#" class="p-3 items-center text-gray-400 hover:text-gray-700 font-semibold text-sm leading-none flex lg:inline-flex px-3">
            ...
            <div class="lg:flex px-10 justify-between items-center">
                <div class="w-full border-t lg:flex items-center h-16 border-gray-400">
                    <p class="text-2xl font-bold mb-2 lg:mb-0 text-gray-400">Hello Element 7 Digital</p>
                </div>
            </div>
        </div>

        <div class="p-10 bg-gray-800">
            <div class="text-gray-200 py-4 text-xl font-semibold">
                <h2>Overview</h2>
            </div>
            <div class="flex flex-wrap -mx-3 mb-6">

                <div class="w-1/2 xl:w-1/4 px-3">                
                    <div class="w-full bg-gray-700 rounded shadow">
                        <div class="md:flex p-2">
                            <div class="pl-2 text-gray-400">
                                <p class="text-sm text-gray-200 font-bold">Unshipped Orders</p>
                                <p class="font-semibold text-3xl ">237</p>
                            </div> 
                        </div>
                        <div class="bg-gray-600 text-gray-400 rounded text-center text-sm font-semibold p-2">
                ...
                <div class="w-1/2 xl:w-1/4 px-3">                
                    <div class="w-full bg-gray-700 rounded shadow">
                        <div class="md:flex p-2">
                            <div class="pl-2 text-gray-400">
                                <p class="text-sm text-gray-200 font-bold">Product Reviews</p>
                ...
                <div class="w-1/2 xl:w-1/4 px-3">                
                    <div class="w-full bg-gray-700 rounded shadow">
                        <div class="md:flex p-2">
                            <div class="pl-2 text-gray-400">
                                <p class="text-sm text-gray-200 font-bold">New Enquiries</p>
                ...
                <div class="w-1/2 xl:w-1/4 px-3">                
                    <div class="w-full bg-gray-700 rounded shadow">
                        <div class="md:flex p-2">
                            <div class="pl-2 text-gray-400">
                                <p class="text-sm text-gray-200 font-bold">Trade Requests</p>
            ...
            <div class="lg:mt-0 mb-6 ">
                ...
                <div class="bg-gray-700 shadow-md rounded overflow-hidden pt-4 pb-4">
                    <div class="p-4"><iframe class="text-gray-200 chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
                        <div class="chartjs-size-monitor text-gray-200" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                        <canvas id="main-graph" class="text-gray-200 mt-4 chartjs-render-monitor" width="821" height="287" style="display: block; width: 821px; height: 287px;"></canvas>
                    </div>
                </div>
            </div>
