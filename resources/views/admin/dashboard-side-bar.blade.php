        ...
        <div class="sticky top-0 z-40">
            ...
            <div class="lg:flex px-10 bg-white justify-between items-center">
                <div class="w-full border-t lg:flex items-center h-16 border-gray-400">
                    <p class="text-2xl font-bold mb-2 lg:mb-0 text-gray-800">Hello Element 7 Digital</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-10 bg-gray-200">
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow-md text-blue-400 rounded flex items-center p-4 pb-8 mb-6 xl:mb-0">
                        <div class="pl-2 text-gray-700">
                            <p class="font-bold text-gray-500">Unshipped Orders</p>
                            <p class="font-semibold text-3xl pb-4">237</p>
                            <a href="" class="text-center text-sm font-semibold bg-gray-100 rounded py-2 px-4">
                                View all Orders
                            </a>
                        </div>                        
                    </div>
                ...
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow-md text-blue-400 rounded flex items-center p-4 pb-8 mb-6 xl:mb-0">
                        <div class="ml-4 pl-2 text-gray-700">
                            <p class="font-bold text-gray-500">Product Reviews</p>
                            <p class="font-semibold text-3xl pb-4">177</p>
                            <a href="" class="text-center text-sm font-semibold bg-gray-100 rounded py-2 px-4">
                                View all Reviews
                            </a>                          
                        </div>
                ...
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow-md text-blue-400 rounded flex items-center p-4 pb-8">
                        <div class="ml-4 pl-2 text-gray-700">
                            <p class="font-bold text-gray-500">New Enquiries</p>
                            <p class="font-semibold text-3xl pb-4">31</p>
                            <a href="" class="text-center text-sm font-semibold bg-gray-100 rounded py-2 px-4">
                                View all Enquiries
                            </a>                            
                        </div>
                ...
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow-md text-blue-400 rounded flex items-center p-4 pb-8">
                        <div class="ml-4 pl-2 text-gray-700">
                            <p class="font-bold text-gray-500">Trade Requests</p>
                            <p class="font-semibold text-3xl pb-4">16</p>
                            <a href="" class="text-center text-sm font-semibold bg-gray-100 rounded py-2 px-4">
                                View all Requests
                            </a>                            
                        </div>
