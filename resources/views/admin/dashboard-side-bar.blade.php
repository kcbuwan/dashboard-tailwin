        ...
        <div class="p-6 bg-gray-100">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow text-blue-400 rounded flex items-center p-4 mb-6 xl:mb-0">
                        ...
                        <div class="ml-4 pl-2 text-gray-700">
                            ...
                            <p class="font-semibold">Unshipped Orders</p>
                        </div>
                    </div>
                </div>
                <div class="w-1/2 xl:w-1/4 px-3">
                ...
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow text-blue-400 rounded flex items-center p-4">
                        <div class="flex-shrink-0">
                            <div class="flex items-center justify-center h-16 w-16 rounded-full bg-blue-400 text-white">
                                <svg viewBox="0 0 20 20" class="w-10 h-10 fill-current hidden lg:block">
