    ...
    <div id="main-content" class="w-full bg-gray-100 pl-0 lg:pl-64 min-h-screen">
        ...
        <div class="p-6 bg-gray-200">
            ...
            <div class="lg:flex justify-between items-center mb-6">
                <p class="text-3xl font-bold mb-2 lg:mb-0 text-gray-800">Hello Element 7 Digital</p>
            </div>
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow-md text-blue-400 rounded flex items-center p-4 mb-6 xl:mb-0">
                        <div class="flex-shrink-0">
                            <div class="flex items-center justify-center h-16 w-16 rounded-full bg-gray-500 text-white">
                ...
                <div class="w-1/2 xl:w-1/4 px-3">
                    <div class="w-full bg-white shadow-md text-blue-400 rounded flex items-center p-4">
                        <div class="flex-shrink-0">
                            <div class="flex items-center justify-center h-16 w-16 rounded-full bg-gray-500 text-white">
                                <svg viewBox="0 0 20 20" class="w-10 h-10 fill-current hidden lg:block">
